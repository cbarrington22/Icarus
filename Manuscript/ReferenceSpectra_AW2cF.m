...
% Reference spectra 
% Model version 
% (1) AW1 cropped spatial frequencies 
% - Real 
% - Complex magnitude 

% addpath '/Users/charlotteb/Documents/Chapter 2/Reference spectra /BootstrapFunction/'
...
% inDirG = '/Users/charlotteb/Documents/Chapter 2/Reference spectra /outFiles/';
inDirG = '/Users/charlott001/Desktop/Reference spectra /outFiles/';
% outDir = '/Users/charlotteb/Documents/Chapter 2/Reference spectra /Model version 1 AW1 cF real comp/';
outDir = '/Users/charlott001/Desktop/Reference spectra /Model version 4 AW2cF bonus high SO2/';
...
% SAVES variables 
fname = fullfile(outDir, 'ReferenceSpectra_AW1cF_G');
...
for s = 1:length(spectraList)
    ...
    if s == 6900 % Index for target d (2080 ppmm at zenith) - same used for figures 
       ...
       box on
       % SAVES FIGURE
       fnOut = 'ReferenceSpectra_AW1cF_dExample';
...
% SAVES variables 
fname = fullfile(outDir, 'ReferenceSpectra_AW1cF_mEst');
save(fname, 'G_real', 'G_realimag', 'elevAn', 'cellCon', 'lambda', 'F', 'Results_mEst_real', 'Results_mEst_realimag', 'Results_res_real', 'Results_res_realimag', 'wavL', 'wavH', 'Ft', 'Fb', 'Results_stdErr_real', 'Results_stdErr_realimag');  
toc 

...
% Reference spectra 
% Model version 
% (2) AW3 cropped spatial frequencies 
% - Real 
% - (Complex magnitude) 
...
outDir = '/Users/charlott001/Desktop/Reference spectra /Model version 2 AW3 cF real (comp)/';
...
% SAVES variables 
fname = fullfile(outDir, 'ReferenceSpectra_AW3cF_G');
...
for s = 1:length(spectraList)
    ...
    if s == 6900 % Index for target d (2080 ppmm at zenith) - same used for figures 
       ...
       box on
       % SAVES FIGURE
       fnOut = 'ReferenceSpectra_AW3cF_dExample';
...
% SAVES variables 
fname = fullfile(outDir, 'ReferenceSpectra_AW3cF_mEst');

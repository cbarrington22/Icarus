...
% Appendix B: Steps for assembling the design matrix G
...
% DESIGN MATRIX, G 
G_real = [WT_I0_real_v, WT_SO2n_real_v]; 
G_realimag = [WT_I0_realimag, WT_SO2n_realimag]; 
% Remove NaN 
